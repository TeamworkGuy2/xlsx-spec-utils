...
suite("DomBuilder", function domBuilder() {
    ...
    test("create w/ lookupAndAddNamespace", function createWithNamespacesTest() {
        ...
        const domBldr = new DomBuilderFactory(dom, "http://schemas.openxmlformats.org/spreadsheetml/2006/main", (elem, name) => XmlFileInst.lookupAndAddNamespace(dom, elem, name));
