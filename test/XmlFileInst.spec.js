...
suite("DomBuilder", function domBuilder() {
    test("create w/ lookupAndAddNamespace", function createWithNamespacesTest() {
        ...
        var domBldr = new DomBuilderFactory_1.DomBuilderFactory(dom, "http://schemas.openxmlformats.org/spreadsheetml/2006/main", function (elem, name) { return XmlFileInst_1.XmlFileInst.lookupAndAddNamespace(dom, elem, name); });
        ...
        asr.equal(dom.documentElement.outerHTML, '<sst xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="xr x14ac" xmlns:xr="http://schemas.microsoft.com/office/spreadsheetml/2014/revision" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">' +
